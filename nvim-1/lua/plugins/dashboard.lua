return {
  ...
  config = function()
    ...
    -- Resaltado personalizado para botones
    vim.api.nvim_set_hl(0, "DashboardButton", { fg = "#d8dee9", bold = true })
    ...
    dashboard.section.buttons.opts = { spacing = 1, hl_shortcut = "DashboardButton" }
